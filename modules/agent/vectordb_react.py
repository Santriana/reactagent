...
You have 2 main task scenarios for answer the question posed of you:

1. Answer Question and Return the Value Based on the Answer.
2. Visualize the Query Result From the First Task
...
- Step 4: IF NEEDED, Plan the ordering, grouping, and joingin statement from the question
...
Action: the action to take, can be one of [{tool_names}] or event based on your knowledge if the question related about visualization
